                    ...
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <Avatar className="h-8 w-8 rounded-lg">
                                ...
                                <AvatarFallback className="rounded-lg">{`${user.user?.first_name ? user.user?.first_name[0] : ''}${user.user?.last_name ? user.user?.last_name[0] : ''}`}</AvatarFallback>
                            </Avatar>
                            <div className="grid flex-1 text-left text-sm leading-tight">
                                <span className="truncate font-medium">{`${user.user?.first_name} ${user.user?.last_name}`}</span>
                    ...
                    >
                        <DropdownMenuLabel className="p-0 font-normal">
                            <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                ...
                                <div className="grid flex-1 text-left text-sm leading-tight">
                                    <span className="truncate font-medium">{user.user?.first_name}</span>
                                    <span className="truncate text-xs">{user.user?.gigatag}</span>
                                </div>
                            </div>
                        </DropdownMenuLabel>
