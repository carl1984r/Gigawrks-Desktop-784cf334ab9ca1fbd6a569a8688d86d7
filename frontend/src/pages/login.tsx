...
import {LoginWithEmail, IsLoggedIn, GetLoggedInUserData} from "../../wailsjs/go/main/App"
        ...
        <div className="min-h-screen flex bg-gray-100 dark:bg-gray-950 transition-colors duration-300">
            ...
            <div className=" dark:text-white hidden sm:flex flex-1 items-center justify-center bg-gray-200 dark:bg-gray-900">
                <img
                    src={logo}
                    alt="Gigawrks Logo"
                    className="max-w-xs sm:w-2/3 w-2/5"
                />
            ...
            <div className="flex flex-1 items-center justify-center p-6">
                ...
                <span className="bg-white dark:bg-gray-900 px-2 text-gray-500 dark:text-gray-400">
                  Or continue with
                        ...
                        <Button
                            variant="outline"
                            className="w-full flex items-center justify-center gap-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
